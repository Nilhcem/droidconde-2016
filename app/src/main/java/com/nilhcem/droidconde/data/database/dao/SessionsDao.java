package com.nilhcem.droidconde.data.database.dao;
...
import com.nilhcem.droidconde.data.database.model.Session;
...
public class SessionsDao {
    ...
    public Observable<List<com.nilhcem.droidconde.data.app.model.Session>> getSessions() {
        return getSessions("SELECT * FROM " + Session.TABLE);
    }

    public Observable<List<com.nilhcem.droidconde.data.app.model.Session>> getSelectedSessions() {
    ...
    public Observable<List<com.nilhcem.droidconde.data.app.model.Session>> getSelectedSessions(LocalDateTime slotTime) {
    ...
    public void toggleSelectedSessionState(com.nilhcem.droidconde.data.app.model.Session session, boolean insert) {
    ...
    public void saveSessions(List<com.nilhcem.droidconde.data.app.model.Session> toSave) {
        Preconditions.checkNotOnMainThread();

        BriteDatabase.Transaction transaction = database.newTransaction();
        try {
            database.delete(Session.TABLE, null);
            for (com.nilhcem.droidconde.data.app.model.Session session : toSave) {
    ...
    public Observable<Boolean> isSelected(com.nilhcem.droidconde.data.app.model.Session session) {
    ...
    private Observable<List<com.nilhcem.droidconde.data.app.model.Session>> getSessions(String query, String... args) {
