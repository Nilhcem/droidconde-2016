package com.nilhcem.devoxxfr.data.database.dao;
...
import com.nilhcem.devoxxfr.data.database.DbMapper;
import com.nilhcem.devoxxfr.data.database.model.SelectedSession;
import com.nilhcem.devoxxfr.data.database.model.Session;
...
public class SessionsDao {
    ...
    public Observable<List<com.nilhcem.devoxxfr.data.app.model.Session>> getSelectedSessions() {
    ...
    public Observable<List<com.nilhcem.devoxxfr.data.app.model.Session>> getSelectedSessions(LocalDateTime slotTime) {
    ...
    public void toggleSelectedSessionState(com.nilhcem.devoxxfr.data.app.model.Session session, boolean insert) {
    ...
    public void saveSessions(List<com.nilhcem.devoxxfr.data.app.model.Session> toSave) {
        Preconditions.checkNotOnMainThread();

        BriteDatabase.Transaction transaction = database.newTransaction();
        try {
            database.delete(Session.TABLE, null);
            for (com.nilhcem.devoxxfr.data.app.model.Session session : toSave) {
    ...
    public Observable<Boolean> isSelected(com.nilhcem.devoxxfr.data.app.model.Session session) {
    ...
    private Observable<List<com.nilhcem.devoxxfr.data.app.model.Session>> getSessions(String query, String... args) {
