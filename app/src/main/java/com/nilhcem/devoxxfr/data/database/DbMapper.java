...
import com.nilhcem.devoxxfr.data.database.model.Speaker;
...
public class DbMapper {
    ...
    public List<com.nilhcem.devoxxfr.data.app.model.Session> toAppSessions(@NonNull List<Session> from, @NonNull Map<Integer, com.nilhcem.devoxxfr.data.app.model.Speaker> speakersMap) {
        return stream(from).map(session -> {
            ...
            return new com.nilhcem.devoxxfr.data.app.model.Session(session.id, Room.getFromId(session.roomId).name,
    ...
    public Session fromAppSession(@Nullable com.nilhcem.devoxxfr.data.app.model.Session from) {
        if (from == null) {
            return null;
        }
    ...
    public Speaker fromAppSpeaker(@Nullable com.nilhcem.devoxxfr.data.app.model.Speaker from) {
        if (from == null) {
            return null;
        }
    ...
    public List<com.nilhcem.devoxxfr.data.app.model.Speaker> toAppSpeakers(@Nullable List<Speaker> from) {
        if (from == null) {
            return null;
        }

        return stream(from).map(speaker -> new com.nilhcem.devoxxfr.data.app.model.Speaker(speaker.id,
