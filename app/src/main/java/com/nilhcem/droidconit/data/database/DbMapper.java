package com.nilhcem.droidconit.data.database;
...
import com.nilhcem.droidconit.data.app.model.Room;
...
public class DbMapper {
    ...
    public List<com.nilhcem.droidconit.data.app.model.Session> toAppSessions(@NonNull List<Session> from, @NonNull Map<Integer, com.nilhcem.droidconit.data.app.model.Speaker> speakersMap) {
        return stream(from).map(session -> {
            LocalDateTime fromTime = localDateTimeAdapter.fromText(session.startAt);
            return new com.nilhcem.droidconit.data.app.model.Session(session.id, Room.getFromId(session.roomId).name,
    ...
    public Session fromAppSession(@Nullable com.nilhcem.droidconit.data.app.model.Session from) {
        if (from == null) {
            return null;
        }
    ...
    public Speaker fromAppSpeaker(@Nullable com.nilhcem.droidconit.data.app.model.Speaker from) {
        if (from == null) {
            return null;
        }
    ...
    public List<com.nilhcem.droidconit.data.app.model.Speaker> toAppSpeakers(@Nullable List<Speaker> from) {
        if (from == null) {
            return null;
        }

        return stream(from).map(speaker -> new com.nilhcem.droidconit.data.app.model.Speaker(speaker.id,
