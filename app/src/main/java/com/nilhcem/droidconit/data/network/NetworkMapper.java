...
public class NetworkMapper {
    ...
    public List<com.nilhcem.droidconit.data.app.model.Speaker> toAppSpeakers(@Nullable List<Speaker> from) {
        ...
        return stream(from).map(speaker -> new com.nilhcem.droidconit.data.app.model.Speaker(
    ...
    public List<com.nilhcem.droidconit.data.app.model.Session> toAppSessions(@Nullable List<Session> from, @NonNull Map<Integer, com.nilhcem.droidconit.data.app.model.Speaker> speakersMap) {
        if (from == null) {
            return null;
        }

        return stream(from).map(session -> new com.nilhcem.droidconit.data.app.model.Session(session.getId(),
