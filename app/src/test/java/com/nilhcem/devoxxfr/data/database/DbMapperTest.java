package com.nilhcem.devoxxfr.data.database;

import android.os.Build;

import com.nilhcem.devoxxfr.BuildConfig;
import com.nilhcem.devoxxfr.core.moshi.LocalDateTimeAdapter;
import com.nilhcem.devoxxfr.data.app.AppMapper;
import com.nilhcem.devoxxfr.data.app.model.Room;
...
public class DbMapperTest {
    ...
    public void should_convert_db_sessions_to_app_sessions() {
        ...
        com.nilhcem.devoxxfr.data.database.model.Session session = new com.nilhcem.devoxxfr.data.database.model.Session(2, "now", 10, 3, "[1]", "title", "description");
        List<com.nilhcem.devoxxfr.data.database.model.Session> sessions = singletonList(session);
    ...
    public void should_convert_app_session_to_db_session() {
        ...
        // When
        com.nilhcem.devoxxfr.data.database.model.Session result = dbMapper.fromAppSession(session);

        // Then
        assertThat(result.id).isEqualTo(11);
        assertThat(result.roomId).isEqualTo(Room.EXHIBITION_FLOOR.id);
    ...
    public void should_convert_app_speaker_to_db_speaker() {
        ...
        // When
        com.nilhcem.devoxxfr.data.database.model.Speaker result = dbMapper.fromAppSpeaker(speaker);
    ...
    public void should_convert_db_speakers_to_app_speakers() {
        // Given
        com.nilhcem.devoxxfr.data.database.model.Speaker speaker = new com.nilhcem.devoxxfr.data.database.model.Speaker(58, "nilh", "dev", "bio", "nilhcem.com", "Nilhcem", "nilhcem", "photo");
